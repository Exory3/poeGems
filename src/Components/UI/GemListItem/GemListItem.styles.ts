...
export const itemContainer = tv({
  base: 'px-2 pt-2 pb-0.5 m-1 rounded-sm h-fit min-h-20 bg-blue-300 flex justify-between cursor-pointer overflow-hidden transition delay-50 ease-in-out hover:bg-blue-400 hover:scale-102',
})
